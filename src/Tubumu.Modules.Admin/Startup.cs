...
namespace Tubumu.Modules.Admin
{
    ...
    public class Startup : StartupBase
    {
        ...
        private void ConfigureSenparc(IApplicationBuilder app, IRouteBuilder routes, IServiceProvider serviceProvider)
        {
            ...
            var senparcSetting = serviceProvider.GetService<IOptions<SenparcSetting>>();
            var senparcWeixinSetting = serviceProvider.GetService<IOptions<SenparcWeixinSetting>>();
            ...
            #region 注册公众号或小程序（按需）
                //注册多个公众号或小程序（可注册多个）
                .RegisterWxOpenAccount(senparcWeixinSetting.Value, "主小程序")
            ...
            #region 注册微信支付（按需）
                //注册最新微信支付版本（V3）（可注册多个）
                .RegisterTenpayV3(senparcWeixinSetting.Value, "主公众号")//记录到同一个 SenparcWeixinSettingItem 对象中
